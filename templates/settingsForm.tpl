...
<h3>{translate key="plugins.importexport.portico.ftpConfig"}</h3>
		...
		{capture assign="exportUrl"}{plugin_url op="importexport" path="issues"}{/capture}
<p>{translate key="plugins.importexport.portico.continue" exportUrl=$exportUrl}</p>
<table width="100%" class="data">
	<tr valign="top">
				<td width="20%" class="label">
					{fieldLabel name="porticoHost" required="true" key="plugins.importexport.portico.porticoHost"}
				</td>
				<td width="80%" class="value">
					<input type="text" name="porticoHost" id="porticoHost" value="{$porticoHost|escape}" size="15" maxlength="25" class="textField" />
	...
	<tr valign="top">
				<td width="20%" class="label">
					{fieldLabel name="porticoUsername" required="true" key="plugins.importexport.portico.porticoUsername"}
				</td>
				<td width="80%" class="value">
					<input type="text" name="porticoUsername" id="porticoUsername" value="{$porticoUsername|escape}" size="15" maxlength="25" class="textField" />
	</td>
	</tr>
	<tr valign="top">
				<td width="20%" class="label">
					{fieldLabel name="porticoPassword" required="true" key="plugins.importexport.portico.porticoPassword"}
				</td>
				<td width="80%" class="value">
					<input type="password" name="porticoPassword" id="porticoPassword" value="{$porticoPassword|escape}" size="15" maxlength="25" class="textField" />
